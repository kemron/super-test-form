...
function SelectFormField<TData>({ label, data, error, optionLabel, optionValue, ...htmlSelectProps }: SelectProps<TData>, ref: React.ForwardedRef<HTMLSelectElement>) {
  return (
    <Field label={label} error={error} >
      <select className="w-full px-4 py-3 leading-4 border-r-[12px] border-transparent" ref={ref} {...htmlSelectProps}>
